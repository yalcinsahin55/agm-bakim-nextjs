    ...
    <div className="sticky top-0 z-20 bg-bg/95 backdrop-blur-md border-b border-border px-4 pt-4 pb-3">
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="md:hidden w-9 h-9 rounded-xl bg-gradient-to-br from-panel to-panel border border-border flex items-center justify-center text-base flex-shrink-0 shadow">
            🔧
          </div>
