    ...
    <div>
      ...
      {confirmationRecord && (
        <MaintenanceConfirmationModal
          ...
          isExternalService={confirmationRecord.technician_source === "external_service" || confirmationRecord.technician_id === EXTERNAL_SERVICE_TECHNICIAN_ID}
          ...
          onCancel={() => { setConfirmationRecord(null); setConfirmationEngineId(""); }}
