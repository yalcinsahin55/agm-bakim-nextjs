      ...
      <div className="min-w-0">
        ...
        <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 font-mono">
          ...
          <span className={delta === null ? "text-faint" : delta < 0 ? "font-bold text-red-300" : "font-bold text-teal"}>
            ...
            <div className="mt-3 flex items-center justify-between gap-2 text-[10px] text-faint"><span>Bir bakım türünü seçerek kayıt ayrıntılarını ve saat farklarını görüntüleyin.</span><span className="hidden sm:inline">Motor değiştirmek için yukarıdaki listeden seçim yapın.</span></div>
          </section>
        </div>
