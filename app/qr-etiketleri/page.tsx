        ...
        <section className="mb-4 rounded-2xl border border-border bg-panel p-4">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button type="button" onClick={printLabels} disabled={!selectedItems.length} className="rounded-lg bg-amber px-3 py-2 text-[11px] font-extrabold text-bg transition hover:brightness-110 disabled:opacity-40">Yazdır / PDF al</Button>
            </div>
          </div>
