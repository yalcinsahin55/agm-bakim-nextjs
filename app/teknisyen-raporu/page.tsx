  ...
  return <div>
    ...
    <main className="px-4 py-4 pb-24">
      ...
      <section className="mb-4 rounded-card border border-border bg-panel p-4">
        ...
        <p className="mb-4 text-[10.5px] text-faint">Her teknisyenin bakım sorumluluğu, ekip katkısı ve kayıtlı çalışma süresi birlikte gösterilir. Birlikte tamamlanan bakım türleri ayrı kayıt olarak görünür; görev ve çalışma süresi toplamlarında aynı grup yalnızca bir kez sayılır.</p>
