...
export async function GET(req) {
  ...
  // Bakım kayıtları — en çok kullanılan sorgular
  ...
  await idx("records", { engine_id: 1, type_key: 1, hour_at_completion: 1 }, "idx_records_engine_type_hour");
  await idx("records", { group_id: 1 }, "idx_records_group");

  // Karter basıncı ölçümleri
