...
export default function EngineMaintenanceCard({ engine, records, open, recordsLoading, onToggle, onShowQr }: EngineMaintenanceCardProps) {
  ...
  return (
    <div className="bg-panel border border-border rounded-card overflow-hidden hover:border-borderlt transition-all">
      <button
        onClick={onToggle}
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="text-[13.5px] font-bold text-text truncate">{engine.name}</div>
