...
export default function SaatGecmisiPage() {
  ...
  const spanDays = history.length >= 2 ? Math.max(1, Math.round((new Date(history[history.length - 1].date) - new Date(history[0].date)) / 86400000)) : 0;
          ...
          <>
            <div className="grid grid-cols-3 gap-2 mb-4">
              ...
              <div className="bg-panel border border-border rounded-card p-2.5">
                ...
                <div className="font-mono text-[15px] font-bold text-amber mt-1">{(totalDelta / spanDays).toFixed(1)} sa</div>
              </div>
              <div className="bg-panel border border-border rounded-card p-2.5">
